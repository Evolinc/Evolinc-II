...
for (my $i=0; $i<@list; $i++) {
        ...
        system("raxmlHPC-PTHREADS-SSE3 --silent -s $file -n RAxML_$file -T $threads -p 85705 -m GTRGAMMA -x 85705 -f a -N 1000 -d > /dev/null 2"); #The /dev/null 2 is used to run the script silently
